...
-- Warehouse for AI/ML workloads (embeddings, ML models, semantic models)
CREATE OR REPLACE WAREHOUSE AI_READY_WH
    ...
    AUTO_RESUME = TRUE
    INITIALLY_SUSPENDED = TRUE
    COMMENT = 'Warehouse for AI/ML workloads - embeddings, ML models, semantic models';
...
CREATE OR REPLACE WAREHOUSE ANALYTICS_WH
    ...
    AUTO_RESUME = TRUE
    INITIALLY_SUSPENDED = TRUE
    COMMENT = 'Warehouse for data science workloads';
...
GRANT USAGE ON WAREHOUSE AI_READY_WH TO ROLE AI_READY_ROLE;
...
GRANT ALL PRIVILEGES ON WAREHOUSE AI_READY_WH TO ROLE ADMIN_ROLE;
